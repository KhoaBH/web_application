        ...
        <ul class="navbar-nav w-100">
            <li class="nav-item w-100">
                <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search">
                    <input type="text" class="form-control" placeholder="Search products" style="color: whitesmoke">
                </form>
            </li>
        </ul>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown">
                    <div class="navbar-profile">
                        ...
                        <p class="mb-0 d-none d-sm-block navbar-profile-name" style="color: white">{{Auth::user()->name}}</p>
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="profileDropdown">
                    ...
                    <a class="dropdown-item preview-item" href="/logout">
                        ...
                        <div class="preview-item-content" >
                            <p class="preview-subject mb-1" href="/logout">Log out</p>
                        </div>
                    </a>
                    <div class="dropdown-divider"></div>
